...
public class TablesController {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "204", description = "Table PATCH: NO_CONTENT"),
        @ApiResponse(responseCode = "400", description = "Table PATCH: BAD_REQUEST"),
        @ApiResponse(responseCode = "401", description = "Table PATCH: UNAUTHORIZED"),
        @ApiResponse(responseCode = "403", description = "Table PATCH: FORBIDDEN"),
        @ApiResponse(responseCode = "404", description = "Table PATCH: TBL_DB_NOT_FOUND")
      })
  @PatchMapping(
      value = {
  ...
  public ResponseEntity<Void> renameTable(
      ...
      @Parameter(description = "Table ID of table to rename") @PathVariable String fromTableId,
