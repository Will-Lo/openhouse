...
public interface TablesApiValidator {
  ...
  /**
   * Function to validate a request to rename a Table Resource with tableId in a given databaseId
   *
   * @param databaseId
   * @param tableId
   * @param newDatabaseId
  ...
  void validateRenameTable(
      String fromDatabaseId, String fromTableId, String newDatabaseId, String newTableId);
